...
REAL_BIN="/Library/Application Support/Native Instruments/Hardware/NIHostIntegrationAgent.app/Contents/MacOS/NIHostIntegrationAgent.real"
LOGGER_DYLIB="/private/tmp/libmk1-call-logger.dylib"
LOG_PATH="/tmp/mk1-call-logger.log"

if [[ ! -x "$REAL_BIN" ]]; then
  echo "Missing real NIHostIntegrationAgent binary: $REAL_BIN" >&2
  exit 1
fi
